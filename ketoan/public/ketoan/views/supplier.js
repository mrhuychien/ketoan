    ...
    html`
      ...
      <div class="kt-card kt-mb">
        ...
        <div class="kt-card-body" style="display:flex;gap:10px;flex-wrap:wrap">
          <a class="kt-btn kt-btn--outline kt-btn--sm" target="_blank" href="/app/supplier/${q(d.supplier)}"><i class="fas fa-up-right-from-square"></i> Mở NCC</a>
          <a class="kt-btn kt-btn--outline kt-btn--sm" target="_blank" href="/app/payment-entry/new?party_type=Supplier&party=${q(d.supplier)}"><i class="fas fa-money-bill-transfer"></i> Lập phiếu chi</a>
          <a class="kt-btn kt-btn--outline kt-btn--sm" target="_blank" href="/app/general-ledger?party_type=Supplier&party=${q(d.supplier)}"><i class="fas fa-book"></i> Sổ cái</a>
          <a class="kt-btn kt-btn--outline kt-btn--sm" target="_blank" href="/app/purchase-invoice?supplier=${q(d.supplier)}"><i class="fas fa-file-invoice"></i> Hóa đơn mua</a>
        </div>
      </div>
          ...
          <div class="kt-table-wrap"><table class="kt-table">
            ...
            <tbody>${d.invoices.map(
              (i) => html`<tr>
                ...
                <td class="num"><a class="kt-btn-icon" target="_blank" href="/app/purchase-invoice/${q(i.name)}"><i class="fas fa-up-right-from-square"></i></a></td>
              </tr>`
            )}</tbody>
          </table></div>
